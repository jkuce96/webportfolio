  ...
  return (
    <div className="mx-auto w-fullů h-[16rem] flex justify-center bg-[#11071F] text-white pb-[25rem] pt-[6rem]">
        <div className="flex flex-row">
            ...
            <button className="mt-[2rem] bg-yellow-400 active:bg-yellow-400 rounded-lg py-4 px-5 text-lg font-bold text-black hover:bg-yellow-500">Otevřít životopis</button>
            </div>
        </div>
